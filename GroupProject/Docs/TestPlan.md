...
|   *Customer*    |     <p>*Customer activity      |     *0000025*      | *We will test if a customer can edit the product details or not* |                *Click on a existing Product*                 |              *Check for edit and delete button*              | *Check for edit and delete button* |         *There will be no option as edit or delete*          |           *There is no option for edit and delete*           |    *Pass*    |
